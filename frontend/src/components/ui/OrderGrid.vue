                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="OrderDt">{{ val.orderDt }}</td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <Date label="OrderDt" v-model="selectedRow.orderDt" :editMode="true"/>
                            <String label="Status" v-model="selectedRow.status" :editMode="true"/>
                            <User offline label="user" v-model="selectedRow.user" :editMode="true"/>
                            <Money offline label="Money" v-model="selectedRow.money" :editMode="true"/>
