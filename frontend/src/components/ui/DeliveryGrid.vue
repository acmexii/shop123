                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="DeliveryDt">{{ val.deliveryDt }}</td>
                            <td class="whitespace-nowrap" label="CjLogis">
                                <CjLogisId :editMode="editMode" v-model="val.cjLogisId"></CjLogisId>
                            </td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <Date label="DeliveryDt" v-model="selectedRow.deliveryDt" :editMode="true"/>
